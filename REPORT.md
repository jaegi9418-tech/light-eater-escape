...
![어두운 초기 상태](docs/images/2_dark_initial.png)
...
![게임 시작 화면](docs/images/1_start_screen.png)
...
![빛 오브 발견 및 힌트 발광 장면](docs/images/5_hint_visible.png)
...
![탈출문 발견 및 클리어](docs/images/6_final_door.png)
*(그림 4: 5개의 오브를 모아 조건이 달성되어 탈출문이 사라지고 통과 가능한 상태)*

![게임 클리어 화면](docs/images/7_clear_screen.png)
...
![빛 오브 발견 장면](docs/images/3_orb_discover.png)
...
![빛 오브 획득 및 SurfelGI 효과](docs/images/4_orb_collect.png)
...
- **웹 실행 링크 (GitHub Pages)**: `[여기에 GitHub Pages 배포 링크를 입력하세요]`
